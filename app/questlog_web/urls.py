...
from .views_2fa import (
    totp_verify, totp_setup, api_2fa_enable, api_2fa_disable, api_2fa_backup_codes,
)
...
from .views_pages import (
    ...
    survival_hub, survival_palworld,
    soulslike_builder, soulslike_builds_browse, sl_my_builds, sl_checklist_landing,
    ...
    api_sl_err_enkindling, api_sl_err_enkindling_eligible,
...
from .views_admin import (
    ...
    api_quest_control_backup_timing,
    api_quest_control_backup_messages,
    api_quest_control_backup_run_now,
...
from .views_soulslike import (
    ...
    api_sl_stop_session,
    api_sl_set_deaths, api_sl_set_session_deaths, api_sl_test_hollow,
    ...
    api_sl_hc_complete, api_sl_submit_to_leaderboard,
...
from .views_soulslike_data import (
    api_sl_data_download, api_sl_data_handoff, api_sl_data_manifest,
...
urlpatterns = [
    ...
    path('2fa/verify/', totp_verify, name='questlog_web_2fa_verify'),
    path('2fa/setup/',  totp_setup,  name='questlog_web_2fa_setup'),
    path('api/2fa/enable/',                    api_2fa_enable,       name='api_2fa_enable'),
    path('api/2fa/disable/',                   api_2fa_disable,      name='api_2fa_disable'),
    path('api/2fa/regenerate-backup-codes/',   api_2fa_backup_codes, name='api_2fa_backup_codes'),
    ...
    path('hosted-games/', game_servers_ql, name='questlog_web_gameservers'),
    path('gameservers/', lambda request: redirect('/hosted-games/', permanent=True), name='questlog_web_gameservers_legacy_redirect'),
    path('survival/',                     survival_hub,           name='survival_hub'),
    path('survival/palworld/',            survival_palworld,      name='survival_palworld'),
    path('soulslike/',                    soulslike_hub,          name='questlog_web_soulslike'),
    path('soulslike/checklist/',          sl_checklist_landing,   name='sl_checklist_landing'),
    path('api/soulslike/hub-stats/',      api_sl_hub_stats,       name='api_sl_hub_stats'),
    path('api/soulslike/data/manifest/', api_sl_data_manifest, name='api_sl_data_manifest'),
    path('api/soulslike/data/handoff/', api_sl_data_handoff, name='api_sl_data_handoff'),
    path('api/soulslike/data/reference-client/', api_sl_data_reference_client, name='api_sl_data_reference_client'),
    path('api/soulslike/data/<str:dataset>/<str:revision>/', api_sl_data_download, name='api_sl_data_download'),
    ...
    path('api/soulslike/err/enkindling/', api_sl_err_enkindling, name='api_sl_err_enkindling'),
    path('api/soulslike/err/enkindling/eligible/', api_sl_err_enkindling_eligible, name='api_sl_err_enkindling_eligible'),
    ...
    path('api/soulslike/session/<str:token>/set-total-deaths/', api_sl_set_deaths, name='api_sl_set_total_deaths'),
    path('api/soulslike/session/<str:token>/set-session-deaths/', api_sl_set_session_deaths, name='api_sl_set_session_deaths'),
    ...
    path('api/soulslike/session/<str:token>/submit-to-leaderboard/', api_sl_submit_to_leaderboard, name='api_sl_submit_to_leaderboard'),
    ...
    # ── Remnant 2 ──────────────────────────────────────────────────────────
    # Entire R2 feature disabled 2026-07-14 while it is rebuilt with
    # original/licensed assets. Keep implementation and DB data intact.
    ...
    # R2 reference, build, run, and manifest APIs are disabled with the pages.
    ...
    path('api/admin/quest-control/backup-timing/', api_quest_control_backup_timing, name='questlog_web_api_qc_backup_timing'),
    path('api/admin/quest-control/backup-messages/', api_quest_control_backup_messages, name='questlog_web_api_qc_backup_messages'),
    path('api/admin/quest-control/backup-run-now/', api_quest_control_backup_run_now, name='questlog_web_api_qc_backup_run_now'),
    ...
    path('api/admin/quest-control/link-guild/', api_quest_control_link_guild, name='questlog_web_api_qc_link_guild'),
    ...
    path('api/soulslike/desktop/builds/<str:build_ref>/', api_sl_build_detail_desktop, name='api_sl_build_detail_desktop'),
    ...
    path('admin/quest-control/', admin_quest_control, name='questlog_web_admin_quest_control'),
